        ...
        {openId != null && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 right-0 z-50 w-full max-w-xl overflow-y-auto border-l border-[oklch(0.85_0.155_86/0.15)] bg-[#0b0b0b] p-6 sm:p-8 shadow-[var(--shadow-premium)]"
            >
